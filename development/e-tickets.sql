...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 08, 2015 at 08:33 PM
...
INSERT INTO `buyback` (`buyback_id`, `user_id`, `ticket_id`, `event_id`, `time_reserved`) VALUES
(25, 8, 49, 3, '20:31:11'),
(26, 8, 50, 3, '20:31:11');
...
(8, 'user8', '67332dfd6cba2083ed4b0993ef6fccfb', 'user8@gmail.com', 'korisnik');
...
--
ALTER TABLE `boughttickets`
MODIFY `bought_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=31;
--
-- AUTO_INCREMENT for table `buyback`
--
ALTER TABLE `buyback`
MODIFY `buyback_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=27;
--
