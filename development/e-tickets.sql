...
(5, 'Вирџинија Вулф', ' "Вирџинија Вулф" – најпознатата пиеса на Едвард Олби, еден од неколкуте највпечатливи драмски наслови, чијашто популарност се едначи со онаа на "Чекајќи го Годо", "Столови", "Госпоѓица Јулија", "Три сестри", "Животот е сон", "Дон Жуан", "Хамлет", "Антигонa". За овие наслови слушнале дури и оние што драмите на кои се однесуваат никогаш не ги гледале или читале. "Вирџинија Вулф" е праизведена пред точно половина век: на 13 октомври 1962 г., на Бродвеј, во тогаш престижниот Били Роуз Театар. Оценета е како шокантна, контроверзна, остра, возбудлива, неодолива…', '2015-02-03', '20:00:00', 5, 'vulfM', 'vulfG',1),
