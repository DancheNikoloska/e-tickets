...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 08, 2015 at 09:49 PM
...
(11, 'Сребрена свадба', 'Монодрамата "Сребрена свадба" според делото Љубовна расправа против еден седнат маж од Габриел Гарсија Маркес, а во режија на Ѕвездана Ангеловска, премиерно ќе биде изведена на Малата сцена на Македонскиот народен театар, кон крајот на април или во почетокот на мај. ', '2015-01-29', '20:00:00', 5, 'svadbaM.jpg', 'svadbaG.jpg', 1);
...
(99, 7, 10, '9a631a8620a42f', 4, 150),
(100, 7, 11, 'b105eb2119d06f', 4, 150),
(101, 7, 9, '5e3a1b59a5e9e2', 4, 150),
(103, 7, 10, '7d5d1a4a64a2f9', 11, 150),
(104, 7, 9, 'ea8520b0a65c62', 11, 150);
...
--
ALTER TABLE `boughttickets`
MODIFY `bought_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=86;
--
-- AUTO_INCREMENT for table `buyback`
--
ALTER TABLE `buyback`
MODIFY `buyback_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=81;
--
